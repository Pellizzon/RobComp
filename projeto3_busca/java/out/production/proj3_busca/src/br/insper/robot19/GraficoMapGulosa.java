...
public class GraficoMapGulosa {
     ...
     */
    public GraficoMapGulosa(GridMap g, int width, int height){
        this.map = g;
        this.width = width;
        this.height = height;
    ...
    public static void main(String[] args) {
         ...
         */
        GraficoMapGulosa grafico = new GraficoMapGulosa(map);
        grafico.desenha();
        grafico.saveFile("BuscaGulosa.png");
        ...
        // Rodando a busca
        BuscaGulosa busca = new BuscaGulosa(map, sb, g);
